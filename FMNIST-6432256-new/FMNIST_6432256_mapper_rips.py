...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec  6 11:03:55 2019
...
def load_weights(model, num_models, weight_dim):
    ...
    for i in range(num_models): 
        model.load_weights('fmnist_model%s_weights.h5' %i)
...
def main(): 
    ...
    graph = mapper.map(lens,
                      ...
                      clusterer=sklearn.cluster.AgglomerativeClustering(n_clusters=2, 
                                                                        linkage = 'single'))
    mapper.visualize(graph, path_html="FMNIST-6432256.html",
                 title="FMNIST-6432256")
